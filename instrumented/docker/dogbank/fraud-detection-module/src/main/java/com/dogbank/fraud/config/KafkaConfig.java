...
public class KafkaConfig {
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, PixTransaction> kafkaListenerContainerFactory() {
        ConcurrentKafkaListenerContainerFactory<String, PixTransaction> factory =
