...
const PixReceiptPage = () => {
  ...
  useEffect(() => {
    ...
    trackProductAction('dogbank.pix.receipt.viewed', {
      amount: details.amount,
      transaction_id: details.transactionId,
      auth_code_present: Boolean(details.authCode),
    });
  }, [details]);
  ...
  const handleShare = () => {
    ...
    trackProductAction('dogbank.pix.receipt.share_clicked', {
      amount: details.amount,
      transaction_id: details.transactionId,
      share_api_available: Boolean(navigator.share),
    });
    if (navigator.share) {
      navigator.share({ 
  ...
  const handlePrint = () => {
    trackProductAction('dogbank.pix.receipt.print_clicked', {
      amount: details.amount,
      transaction_id: details.transactionId,
    });
    window.print();
