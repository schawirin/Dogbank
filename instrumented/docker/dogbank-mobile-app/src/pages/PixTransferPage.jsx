...
const PixTransferPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    trackProductAction('dogbank.pix.confirmation_opened', {
      amount: numericAmount,
      pix_key_type: pixKey.includes('@') ? 'email' : 'other',
      source_account_id: accountData?.id,
      receiver_name: recipientInfo?.nome || '',
    });
  ...
  const handleQuickAmount = (value) => {
    ...
    setAmountError('');
    trackProductAction('dogbank.pix.quick_amount_selected', {
      amount: value,
    });
  };
  ...
  return (
    <div className="py-6">
      ...
      {accountData && (
        <div className="mb-8 p-6 bg-gradient-to-r from-purple-500 to-violet-600 rounded-2xl text-white shadow-lg shadow-purple-500/20">
