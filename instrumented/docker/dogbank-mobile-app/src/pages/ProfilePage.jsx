...
const ProfilePage = () => {
  ...
  return (
    <div className="py-4 sm:py-6 max-w-5xl mx-auto w-full min-w-0">
      {/* Cabeçalho */}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6">
        ...
        <div className="lg:col-span-2 space-y-4 sm:space-y-6 min-w-0">
          ...
          <div className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden min-w-0">
            {/* Header com Avatar */}
            <div className="bg-gradient-to-r from-purple-600 to-violet-600 px-5 sm:px-6 py-6 sm:py-8">
              <div className="flex items-center gap-4 min-w-0">
                <div className="w-16 h-16 sm:w-20 sm:h-20 bg-white rounded-full flex flex-shrink-0 items-center justify-center shadow-lg">
                  <span className="text-2xl sm:text-3xl font-bold text-purple-600">
                    {(user?.nome || 'U').charAt(0).toUpperCase()}
                  </span>
                </div>
                <div className="text-white min-w-0">
                  <h2 className="text-xl sm:text-2xl font-bold leading-tight break-words">{user?.nome || 'Cliente DogBank'}</h2>
            ...
            <div className="p-5 sm:p-6">
              ...
              <div className="space-y-4">
                {/* Nome */}
                <div className="flex items-center justify-between gap-3 p-4 bg-slate-50 rounded-xl min-w-0">
                  <div className="flex items-center gap-3 min-w-0">
                    <div className="w-10 h-10 bg-purple-100 rounded-lg flex flex-shrink-0 items-center justify-center">
                      <User className="w-5 h-5 text-purple-600" />
                    </div>
                    <div className="min-w-0">
                      <p className="text-sm text-slate-500">Nome Completo</p>
                      <p className="font-medium text-slate-900 break-words">{user?.nome || 'N/A'}</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex items-center justify-between gap-3 p-4 bg-slate-50 rounded-xl min-w-0">
                  <div className="flex items-center gap-3 min-w-0">
                    <div className="w-10 h-10 bg-blue-100 rounded-lg flex flex-shrink-0 items-center justify-center">
                      <FileText className="w-5 h-5 text-blue-600" />
                    </div>
                    <div className="min-w-0">
                      <p className="text-sm text-slate-500">CPF</p>
                      <p className="font-medium text-slate-900 font-mono text-sm sm:text-base break-words">{formatCPF(cpf)}</p>
                    </div>
                  </div>
                  <button 
                ...
                <div className="flex items-center justify-between gap-3 p-4 bg-slate-50 rounded-xl min-w-0">
                  <div className="flex items-center gap-3 min-w-0">
                    <div className="w-10 h-10 bg-green-100 rounded-lg flex flex-shrink-0 items-center justify-center">
                      <Mail className="w-5 h-5 text-green-600" />
                    </div>
                    <div className="min-w-0">
                      <p className="text-sm text-slate-500">E-mail</p>
                      <p className="font-medium text-slate-900 text-sm sm:text-base break-all">{email}</p>
                    </div>
                  </div>
                  <button 
                ...
                <div className="flex items-center justify-between gap-3 p-4 bg-slate-50 rounded-xl min-w-0">
                  <div className="flex items-center gap-3 min-w-0">
                    <div className="w-10 h-10 bg-orange-100 rounded-lg flex flex-shrink-0 items-center justify-center">
                ...
                {/* Chave PIX */}
                <div className="flex items-center justify-between gap-3 p-4 bg-gradient-to-r from-purple-50 to-violet-50 rounded-xl border border-purple-100 min-w-0">
                  <div className="flex items-center gap-3 min-w-0">
                    <div className="w-10 h-10 bg-purple-100 rounded-lg flex flex-shrink-0 items-center justify-center">
                    ...
                    <div className="min-w-0">
                      ...
                      <p className="font-medium text-purple-700 text-sm sm:text-base break-all">{pixKey}</p>
                    </div>
                  </div>
                  <button 
                    onClick={() => copyToClipboard(pixKey, 'pix')}
                    className="text-purple-400 hover:text-purple-600 p-2 flex-shrink-0"
                  >
        ...
        <div className="space-y-4 sm:space-y-6 min-w-0">
          ...
          {/* Recomendações */}
          <div className="bg-gradient-to-br from-purple-50 to-violet-50 rounded-2xl border border-purple-100 p-5 sm:p-6 min-w-0">
