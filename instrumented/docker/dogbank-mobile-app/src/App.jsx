...
import { trackProductView } from './utils/productAnalytics';
...
const ProductAnalyticsRouteObserver = () => {
  const location = useLocation();
  const { user } = useContext(AuthContext);

  useEffect(() => {
    trackProductView(location.pathname, {
      user_id: user?.cpf || user?.accountId,
