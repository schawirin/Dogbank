...
# Intervalo entre ataques (segundos) - REDUZIDO PARA DEMOS
MIN_INTERVAL = float(os.getenv('ATTACK_MIN_INTERVAL', '2'))
MAX_INTERVAL = float(os.getenv('ATTACK_MAX_INTERVAL', '8'))

# Probabilidades de cada tipo de ataque - AUMENTADO SQL E RCE PARA DEMOS
PROB_SQL_INJECTION = float(os.getenv('PROB_SQL_INJECTION', '0.35'))
PROB_RCE = float(os.getenv('PROB_RCE', '0.35'))
PROB_LOG4SHELL = float(os.getenv('PROB_LOG4SHELL', '0.10'))
PROB_PATH_TRAVERSAL = float(os.getenv('PROB_PATH_TRAVERSAL', '0.08'))
PROB_XSS = float(os.getenv('PROB_XSS', '0.05'))
PROB_AUTH_BYPASS = float(os.getenv('PROB_AUTH_BYPASS', '0.04'))
PROB_IDOR = float(os.getenv('PROB_IDOR', '0.03'))
