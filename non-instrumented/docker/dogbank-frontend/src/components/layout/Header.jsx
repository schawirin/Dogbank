          ...
          {isAuthenticated ? (
            <div className="flex items-center space-x-6">
              <div className="hidden md:flex items-center space-x-6">
                ...
                <Link to="/pix" className="text-neutral-700 hover:text-primary-500 transition-colors font-medium">
                  PIX
                </Link>
                <Link to="/extrato" className="text-neutral-700 hover:text-primary-500 transition-colors font-medium">
                  Extrato
                </Link>
                <Link to="/cartoes" className="text-neutral-700 hover:text-primary-500 transition-colors font-medium">
                  Cartões
                </Link>
              </div>
              ...
              <div className="relative group">
                <button className="flex items-center space-x-2">
                  ...
                  <span className="hidden md:inline text-neutral-700">{user?.nome || 'Usuário'}</span>
                </button>
            ...
            <div className="flex items-center space-x-4">
              <Link
                to="/login"
                className="px-4 py-2 rounded-lg border border-primary-500 text-primary-500 hover:bg-primary-500 hover:text-white transition-colors"
              >
                Entrar
              </Link>
            </div>
