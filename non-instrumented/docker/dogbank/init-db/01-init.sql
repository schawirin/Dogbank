...
UPDATE contas SET saldo = 8500.00, banco = 'CatBank', user_name = 'João Santos' WHERE numero_conta = '0003-2';
...
UPDATE contas SET saldo = 20000.00, banco = 'WolfBank', user_name = 'Patrícia Souza' WHERE numero_conta = '0006-5';
